...
public class Console implements Ui {
    ...
    private void showMenu() {
        ...
        System.out.println("6 - numarul de comunitati(comp conexe)");
        ...
        while (true) {
            ...
            switch (option) {
                ...
                case 2 -> {
                    ...
                    //addUser(strings.get(1), strings.get(2));
     ...
     */
    private void addFriendship(String id, String id1, String id2, String friendsFr) {
        try {
            friendshipService.addFriend(id, id1, id2, friendsFr);
