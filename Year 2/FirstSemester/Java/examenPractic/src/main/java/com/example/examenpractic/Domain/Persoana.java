...
public class Persoana extends Entity<Long>{
    ...
    public Persoana(Long aLong, String nume, String prenume, String username, String parola, Oras oras, String strada, String numarStrada, String telefon) {
        super(aLong);
        this.nume = nume;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), nume, prenume, username, parola, oras, strada, numarStrada, telefon);
    }
