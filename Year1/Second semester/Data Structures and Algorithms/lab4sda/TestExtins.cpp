...
void testAllExtins() {
    ...
    testCreeaza();
    std::cout<<"Trece test creeaza!"<<std::endl;
    testAdauga();
    std::cout<<"Trece test adauga!"<<std::endl;
    testSterge();
    std::cout<<"Trece test sterge!"<<std::endl;
    testIterator();
    std::cout<<"Trece test iterator!"<<std::endl;
    testQuantity();
    std::cout<<"Trece test quantity!"<<std::endl;
