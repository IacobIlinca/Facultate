...
void testAllExtins() {
	testCreeaza();
	std::cout<<"Trece teste creeaza!"<<endl;
	testAdauga();
	std::cout<<"Trece teste adauga!"<<endl;
	testCauta();
	std::cout<<"Trece teste cauta!"<<endl;
	testSterge();
	std::cout<<"Trece teste sterge!"<<endl;
	testIterator();
	std::cout<<"Trece teste iterator!"<<endl;
	testCantitativ();
	std::cout<<"Trece teste cantitate!"<<endl;
}
