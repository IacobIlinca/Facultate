...
private:
	...
	QPushButton* coscrud = new QPushButton("----RETETACRUD-----");;

	QPushButton* cosread = new QPushButton("----RETETAREADONLY-----");
	QPushButton* addcos = new QPushButton("ADAUGARE MEDIWCAMENT RETETA");
	QPushButton* dellcos = new QPushButton("GOLIRE RETETA");
	QPushButton* randomcos = new QPushButton("GENERARE MEDICAMENTE RETETA");
	QWidget* cos13 = new QWidget;
	QFormLayout* cos13layout = new QFormLayout;
	QLabel* lblnumecos13 = new QLabel("Nume produs:");
	QLabel* lblprodcos13 = new QLabel("Producator produs:");
	QLineEdit* txtnumecos13 = new QLineEdit;
	QSlider* slider13 = new QSlider;
